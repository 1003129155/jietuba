# -*- coding: utf-8 -*-
"""翻译对话框 - DeepL API 集成 UI

允许用户在 QTextEdit 中查看 OCR 识别结果，选择目标语言后调用 DeepL API
进行翻译，显示结果在下方输出区域。
"""
...
class TranslationDialog(QDialog):
    ...
    def _create_left_panel(self):
        ...
        self.source_edit.setAcceptRichText(False)  # 只接受纯文本，忽略CSS样式
    ...
    def _create_right_panel(self):
        ...
        self.target_edit.setAcceptRichText(False)  # 只接受纯文本，忽略CSS样式
    ...
    def _on_target_lang_changed(self, index):
        ...
        if target_lang:
            ...
            log_debug(f"Target language saved to registry: {target_lang}", "Translation")
